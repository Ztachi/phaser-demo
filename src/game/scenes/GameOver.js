...
export class GameOver extends Scene {
    ...
    create() {
        // 设置游戏状态为结束并更新最高分
        setGameOverState(this.registry);
        ...
        // 最终得分
        this.add.text(400, 280, `最终得分: ${this.registry.get('score')}`, {
            fontFamily: 'Arial', 
            fontSize: 32, 
            color: '#ffffff',
            stroke: '#000000', 
        ...
        // 等级显示
        this.add.text(400, 320, `等级: ${this.registry.get('level')}`, {
            fontFamily: 'Arial', 
            fontSize: 24, 
            color: '#f39c12',
            stroke: '#000000', 
        ...
        // 收集的星星数量
        this.add.text(400, 350, `收集星星: ${this.registry.get('starsCollected')}`, {
            fontFamily: 'Arial', 
            fontSize: 24, 
            color: '#f1c40f',
            stroke: '#000000', 
        ...
        // 最高分显示
        this.add.text(400, 400, `最高分: ${this.registry.get('highScore')}`, {
            fontFamily: 'Arial', 
            fontSize: 28, 
            color: '#e67e22',
            stroke: '#000000', 
